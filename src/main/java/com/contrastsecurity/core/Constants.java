...
public interface Constants {
    ...
    String VULNERABILITY_STATUS_NOT_A_PROBLEM_COMBO_BOX_ITEM = "Not a Problem";
    String VULNERABILITY_STATUS_NOT_A_PROBLEM_API_REQUEST_STRING = "NotAProblem";
    ...
    String REASON_URL_IS_ONLY_ACCESSIBLE_BY_TRUSTED_POWER_USERS = "URL is only accessible by trusted power users";
    String REASON_FALSE_POSITIVE = "False positive";
    String REASON_GOES_THROUGH_AN_INTERNAL_SECURITY_CONTROL = "Goes through an internal security control";
    String REASON_ATTACK_IS_DEFENDED_BY_AN_EXTERNAL_CONTROL = "Attack is defended by an external control";
    String REASON_OTHER = "Other";
